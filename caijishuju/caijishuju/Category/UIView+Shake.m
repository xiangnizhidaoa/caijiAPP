...
+ (void)ShakeLoginViewForincorrectPassword:(id)view isPlaySystemSound:(BOOL)isPlay {
    ...
    UIView *shakeView = view;
    // Clear the password field
    
    CGAffineTransform moveRight = CGAffineTransformTranslate(CGAffineTransformIdentity, 8, 0);
    CGAffineTransform moveLeft = CGAffineTransformTranslate(CGAffineTransformIdentity, -12, 0);
    CGAffineTransform moveRight2 = CGAffineTransformTranslate(CGAffineTransformIdentity, 2, 0);
    CGAffineTransform moveLeft2 = CGAffineTransformTranslate(CGAffineTransformIdentity, -5, 0);
         ...
         [UIView animateWithDuration:0.1 animations:^{
             ...
             [UIView animateWithDuration:0.1 animations:^{
                 ...
                 [UIView animateWithDuration:0.1 animations:^{
                     ...
                     // Translate to moveRight2
                     shakeView.transform = moveRight2;
